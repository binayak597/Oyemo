const Header = () => {
  return (
    <section className="relative h-[70vh] md:h-[80vh] lg:h-[85vh] max-h-[600px] mx-4 md:mx-6 lg:mx-8 mt-6 md:mt-8 overflow-hidden rounded-2xl md:rounded-3xl shadow-2xl">
