      ...
      <div className="w-[90%] max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center space-x-4 lg:space-x-6">
            ...
            {/* Sign In Button */}
            <button className="px-6 py-2 lg:px-8 lg:py-2.5 text-sm lg:text-base font-medium text-[#23CE6B] border-2 border-[#23CE6B] rounded-full hover:bg-[#23CE6B] hover:text-white transition-all duration-300 hover:shadow-lg hover:scale-105">
              Sign In
            </button>
          </div>
        ...
        <div className={`lg:hidden transition-all duration-300 ease-in-out overflow-hidden ${
          ...
          <div className="py-4 space-y-2 bg-gradient-to-b from-[#E8FCCF] to-white rounded-b-xl">
            ...
            <div className="px-6 pt-4">
              <button className="w-full py-3 text-center font-medium text-[#23CE6B] border-2 border-[#23CE6B] rounded-full hover:bg-[#23CE6B] hover:text-white transition-all duration-300">
                Sign In
              </button>
            </div>
          </div>
